      ...
      <div className="container">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Visit our store or reach us directly via call or WhatsApp.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-stretch">
          {/* Map */}
          <div className="rounded-2xl overflow-hidden border border-border card-shadow h-[420px]">
            <iframe
          ...
          {/* Contact Info */}
          <div className="bg-card rounded-2xl p-8 md:p-10 border border-border card-shadow flex flex-col justify-between">
            <div>
